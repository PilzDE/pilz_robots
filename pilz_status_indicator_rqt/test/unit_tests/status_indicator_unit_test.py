...
class TestStatusIndicator(unittest.TestCase):
    ...
    def test_status_prbt(self, ViewMock, SubscriberMock):
        ...
        diagnostic_prbt_callback = extract_subscriber_mock_callback(SubscriberMock, TOPIC_DIAGNOSTICS_PRBT)
    ...
    def test_status_ros(self, ViewMock, SubscriberMock):
        ...
        diagnostic_ros_callback = extract_subscriber_mock_callback(SubscriberMock, TOPIC_DIAGNOSTICS_ROS)
    ...
    def test_operation_mode(self, ViewMock, SubscriberMock):
        ...
        diagnostic_operation_mode_callback = extract_subscriber_mock_callback(SubscriberMock, TOPIC_OPERATION_MODE)
        ...
        psi._widget.set_operation_mode.assert_called_with(OperationModes.UNKNOWN)
    ...
    def test_set_speed(self, ViewMock, SubscriberMock):
        ...
        speed_callback = extract_subscriber_mock_callback(SubscriberMock, TOPIC_SPEED_OVERRIDE)
