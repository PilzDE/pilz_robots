...
using IsControllerExecutingFunc = std::function<bool(const ControllerPtr&)>;
...
static bool InvokeIsExecutingServiceCallback(const ControllerPtr& controller)
{
  ...
  {
    throw std::runtime_error("Callback of is_executing unexpectedly returned false.");
  }
...
class PilzJointTrajectoryControllerIsExecutingTest : public testing::Test,
                                                     public testing::WithParamInterface<IsControllerExecutingFunc>
{
protected:
  void SetUp() override;
