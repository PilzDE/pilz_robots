...
int main(int argc, char **argv)
{
  ...
  ModbusAdapterRunPermitted adapter_run_permitted(std::bind(sendRunPermittedUpdate, run_permitted_service, _1), api_spec);
  FilterPipeline filter_pipeline( nh, std::bind(&ModbusAdapterRunPermitted::modbusMsgCallback, &adapter_run_permitted, _1) );
