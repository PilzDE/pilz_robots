...
int main(int argc, char** argv)
{
  ...
  SetSpeedLimitFunc set_speed_limit_func = std::bind(setSpeedLimitSrv<ros::ServiceClient>, speed_limit_srv, _1);
  ...
  OperationModeSetupExecutor op_mode_executor(speed_limit_t1, speed_limit_auto, set_speed_limit_func);
