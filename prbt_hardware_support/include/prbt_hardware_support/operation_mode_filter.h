 ...
 */
template <typename M>
class OperationModeFilter : public SimpleFilter<M>
{
public:
  ...
  void connectInput(F &f)
  {
    ...
    incoming_connection_ = f.registerCallback(typename OperationModeFilter<M>::EventCallback(boost::bind(&OperationModeFilter::cb,
                                                                                                     this, _1)));
  }
