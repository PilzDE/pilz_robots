...
public:
  ...
  MOCK_METHOD2(sendBrakeTestResult, bool(SendBrakeTestResult::Request&, SendBrakeTestResult::Response&));

protected:
  ros::NodeHandle nh_;
  ManipulatorMock manipulator_;

  ros::ServiceServer brake_test_service_ {nh_.advertiseService(BRAKETEST_ADAPTER_SERVICE_NAME,
                                                               &BrakeTestExecutorTest::triggerBrakeTest,
                                                               this)};

  ros::ServiceServer brake_test_result_server_ {nh_.advertiseService(BRAKE_TEST_RESULT_SERVICE_NAME,
                                                                     &BrakeTestExecutorTest::sendBrakeTestResult,
                                                                     this)};
