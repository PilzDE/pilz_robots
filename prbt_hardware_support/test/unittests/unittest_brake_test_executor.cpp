...
static const std::string CONTROLLER_UNHOLD_MODE_SERVICE_NAME{ "/prbt/"
                                                              ...
                                                              "controller/"
                                                              "unhold" };
static const std::string MODBUS_SERVICE_NAME{ "/pilz_modbus_client_node/"
                                              "modbus_write" };

static const std::string API_SPEC_PARAM_NAME{ "/write_api_spec" };
static const std::string BRAKETEST_PERFORMED_PARAM_NAME{ "/BRAKETEST_"
                                                         "PERFORMED" };
 ...
 * The hold service is not called.
 */
