...
### Test Sequence
  ...
  Run `roslaunch prbt_moveit_config moveit_planning_execution.launch sim:=False pipeline:=pilz_command_planner safety_hw:=pss4000 has_braketest_support:=true gripper:=pg70`
