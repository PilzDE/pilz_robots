...
static const std::string MONITOR_CARTESIAN_SPEED_SERVICE{"manipulator_joint_trajectory_controller/monitor_cartesian_speed"};
...
{
  monitor_cartesian_speed_srv_ = nh_.advertiseService(MONITOR_CARTESIAN_SPEED_SERVICE,
                                                      &ControllerMock::monitor_cartesian_speed_callback_,
                                                      this);
}
